...
import LetsCollaborateInput from "../components/LetsCollaborateInput";
        ...
        <View style={styles.container1}>
          ...
          <View style={styles.container}>
            ...
            <View paddingTop={40} paddingBottom={10}>
              <LetsCollaborateInput userData={user} onChange={x => this.setState({ status: x })} />
            </View>
            <View
              marginHorizontal={15}
              flex={1}
